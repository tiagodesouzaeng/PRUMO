...
async function criarApi(){return criarAplicacaoApi({repository:criarRepositorioMemoria({tenants:[{id:"EMP-1",nome:"Órgão",status:"ativo"}],memberships:[{tenantId:"EMP-1",subject:"ADMIN",perfilId:"administrador",teamIds:["EQ-1"],status:"ativo"}],unidadesPatrimoniais:[{id:"SALA-1",tenantId:"EMP-1",teamId:"EQ-1",nivel:"sala",codigo:"SL-01",nome:"Sala técnica",status:"ativo",versao:1}],orcamentos:[{id:"ORC-1",tenantId:"EMP-1",teamId:"EQ-1",nome:"Orçamento aprovado",dados:{status:"Aprovado"},versao:1}],contratosGestao:[{id:"CT-1",tenantId:"EMP-1",teamId:"EQ-1",numero:"001/2026",titulo:"Contrato da obra",status:"vigente",valorAtual:90000,versao:1}],basesContratadas:[{id:"BASE-1",tenantId:"EMP-1",teamId:"EQ-1",orcamentoId:"ORC-1",fornecedor:"Construtora exemplo",valorPublicado:100000,valorContratado:90000,descontoPercentual:10,status:"homologada",itens:[{itemId:"ITEM-1",codigo:"1.1",descricao:"Serviço",unidade:"UN",quantidade:1,precoPublicadoUnitario:100000,precoContratadoUnitario:90000,totalPublicado:100000,totalContratado:90000}],criadoEm:"2026-08-01T00:00:00.000Z"}]}),authenticate:async()=>({subject:"ADMIN"})});}
...
test("API executa obra, cronograma, diário e medição até o aceite",async(t)=>{
  ...
  const criada=await app.inject({method:"POST",url:"/v1/obras",headers:headers("OBRA-1"),payload:{patrimonioUnidadeId:"SALA-1",contractId:"CT-1",orcamentoId:"ORC-1",codigo:"OB-001",nome:"Reforma da sala técnica",responsavel:"Fiscal",dataInicio:"2026-08-01",dataFimPrevista:"2026-12-20",valorPrevisto:100000,dados:{}}});
